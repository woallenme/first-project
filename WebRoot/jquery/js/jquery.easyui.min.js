...
_4ee.cellClassPrefixmini="datagrid-cell-c";
...
col.cellClassmini=_4ee.cellClassPrefixmini+"-"+col.field.replace(/[\.|\s]/g,"-");
}else{
...
var _660=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody id=\"more\">"];
for(var i=0;i<rows.length;i++){
...
cc.push(col.checkbox?"class=\"datagrid-cell-check\"":"class=\"datagrid-cell "+col.cellClass+" "+col.cellClassmini+"\"");
cc.push(">");
if(col.checkbox){
